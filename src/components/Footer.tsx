  ...
  return (
    <footer className="bg-zinc-900 border-t border-zinc-700 px-6 py-4 flex items-center justify-between">
      <div className="flex items-center gap-3">
        <Image src="/phonk.jpg" alt="lxst cxntury" width={56} height={56} />
        <div className="flex flex-col">
          <strong className="font-normal">Deep Fusion</strong>
          <span className="text-xs text-zinc-400">Lxst Cxntury</span>
        </div>
      </div>
